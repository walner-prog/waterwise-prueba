...
<div class="container mt-4 toggle-container">
        ...
        <div class="col">
            <nav aria-label="breadcrumb" class="rounded-3 p-3 mb-4">
                <ol id="breadcrumb" class="breadcrumb mb-0 text-light">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Registros de Facturas</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-2">
              {{--             <a href="{{ url('facturas/create') }}" class="btn btn-indigo mb-3">
        ...
        <table id="facturasTable" class="min-w-full w-full w-100 border border-gray-300 shadow-md rounded-lg p-2">
            <thead class="bg-gradient-to-r from-blue-500 to-blue-600 text-white w-full">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-base font-medium tracking-wider border-b border-gray-200">Tarifa</th>
                    ...
                    <th class="px-6 py-3 text-left text-base font-medium tracking-wider border-b border-gray-200">Estado Pago</th>
...
$(document).ready(function() {
    $('#facturasTable').DataTable({
     ...
     $('#facturasTable').on('click', '.delete-btn', function() {
        var id = $(this).data('id'); // Obtiene el ID de la factura
        var url = "{{ url('facturas') }}/" + id; // Genera la URL de eliminación
        
        Swal.fire({
            title: '¿Estás seguro?',
            text: "¡No podrás revertir esto!, debes   eliminar también los ingresos asociados para evitar inconsistencias en tus datos ",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#facturasTable').DataTable().ajax.reload(); // Recarga la tabla
                    },
